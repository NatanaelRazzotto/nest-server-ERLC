...
-- CreateIndex
CREATE UNIQUE INDEX "natural_person_npf_key" ON "natural_person"("npf");

-- CreateIndex
CREATE UNIQUE INDEX "natural_person_person_id_key" ON "natural_person"("person_id");

-- CreateIndex
CREATE INDEX "natural_person_npf_idx" ON "natural_person"("npf");

-- CreateIndex
CREATE UNIQUE INDEX "legal_person_ipj_key" ON "legal_person"("ipj");

-- CreateIndex
CREATE UNIQUE INDEX "legal_person_person_id_key" ON "legal_person"("person_id");

-- CreateIndex
CREATE INDEX "legal_person_ipj_idx" ON "legal_person"("ipj");
...
-- AddForeignKey
ALTER TABLE "legal_person" ADD CONSTRAINT "legal_person_person_id_fkey" FOREIGN KEY ("person_id") REFERENCES "person"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
